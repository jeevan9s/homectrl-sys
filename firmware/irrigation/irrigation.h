...
#define IRRIG_TOPIC_STATUS           IRRIG_MQTT_BASE "/status"
#define IRRIG_TOPIC_LAST_DURATION       IRRIG_MQTT_BASE "/last_duration_ms" 
...
unsigned long irrigationGetLastDurationMs();
